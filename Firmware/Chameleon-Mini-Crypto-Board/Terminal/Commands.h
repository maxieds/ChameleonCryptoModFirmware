...
/* This is just for the CommandLine module to know that this is a timeout command: */
...
typedef uint16_t CommandStatusIdType;
...
#define COMMAND_UPLOAD_STATUS     "UPLOAD_STATUS"
